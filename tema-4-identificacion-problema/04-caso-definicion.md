...
El Tema 4 cierra redactando lo que la guía de estudio denomina el documento de definición del problema, el producto de la etapa 1. Es el documento que, en un proyecto real, se acordaría con el cliente antes de tocar una sola línea de modelado, pues fija el contrato de qué se va a responder y cómo se va a juzgar. Se presenta completo para el caso del PIB de BRICS+ frente a G7, integrando las cinco dimensiones y el EDA de los capítulos anteriores.
...
Diez años de proyección, con datos históricos desde 1995 para asegurar la comparabilidad del bloque ampliado. El horizonte se justifica porque es suficiente para que la dinámica de la transición se exprese y porque excede el rango donde el intervalo de predicción se vuelve inutilizable con datos anuales.
...
Se aplica el test de sensibilidad informal a los supuestos principales.
...
Los supuestos críticos son los que, de estar equivocados, cambiarían la conclusión, y por ello reciben tratamiento explícito. Los secundarios se documentan como simplificaciones.
...
2. Fondo Monetario Internacional. (2024). *World Economic Outlook database*. https://www.imf.org/en/Publications/WEO
